$(document).ready(function () {
    if(window.location.href.indexOf("/latest/") != -1) {
        ...
        banner.innerHTML = "You are currently reading documentation for the \"dev\" branch of TACTICS. This documentation refers to features currently in development and may result in unexpected behaviour. To read documentation for previous releases, select the desired version in the bottom, right-hand corner of the screen.";
